...
int main(void) {
    ...
    auto material_center = make_shared<lambertian>(color3(0.7f, 0.3f, 0.3f));
    auto material_left   = make_shared<metal>(color3(0.8f, 0.8f, 0.8f));
    auto material_right  = make_shared<metal>(color3(0.8f, 0.6f, 0.3f));
