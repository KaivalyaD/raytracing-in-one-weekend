...
int main(void) {
    ...
    // world
    hittable_list world;
    world.add(make_shared<sphere>(point3(0.0f, -100.5f, -1.0f), 100.0f, make_shared<lambertian>(color3(0.0f, 1.0f, 0.0f))));
    world.add(make_shared<sphere>(point3(0.0f, 0.0f, -1.0f), 0.5f, make_shared<lambertian>(color3(1.0f, 0.0f, 0.0f))));
